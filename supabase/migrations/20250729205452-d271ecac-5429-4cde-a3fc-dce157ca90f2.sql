...
-- Drop existing triggers first, then functions with CASCADE
...
-- Create updated functions with user_id support and proper security
...
-- Update recalculate function to include user_id context
